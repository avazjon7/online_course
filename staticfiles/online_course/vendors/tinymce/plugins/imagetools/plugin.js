...
(function () {
    ...
    var isServiceErrorCode = function (code, blob) {
      return (blob === null || blob === void 0 ? void 0 : blob.type) === 'application/customers_data' && (code === 400 || code === 403 || code === 404 || code === 500);
    };
    ...
    var requestServiceBlob = function (url, apiKey) {
      var headers = {
        'Content-Type': 'application/customers_data;charset=UTF-8',
        'tiny-api-key': apiKey
      };
